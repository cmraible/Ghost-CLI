...
* **backup:** fixed exporting all members ([daf4798](https://github.com/TryGhost/Ghost-CLI/commit/daf4798))
...
* **config:** add 'ses' to valid mail config transport options ([#492](https://github.com/TryGhost/Ghost-CLI/issues/492)) ([7f51138](https://github.com/TryGhost/Ghost-CLI/commit/7f51138)), closes [#467](https://github.com/TryGhost/Ghost-CLI/issues/467)
* **config:** add default dbpath when db is sqlite ([778aafa](https://github.com/TryGhost/Ghost-CLI/commit/778aafa)), closes [#349](https://github.com/TryGhost/Ghost-CLI/issues/349)
...
* **doctor:** refactor doctor command ([76829e9](https://github.com/TryGhost/Ghost-CLI/commit/76829e9)), closes [#47](https://github.com/TryGhost/Ghost-CLI/issues/47)
...
* **instance:** make running a function rather than a get/set ([0cef275](https://github.com/TryGhost/Ghost-CLI/commit/0cef275)), closes [#435](https://github.com/TryGhost/Ghost-CLI/issues/435)
...
* **local:** only force kill on Windows ([be95343](https://github.com/TryGhost/Ghost-CLI/commit/be95343)), closes [#368](https://github.com/TryGhost/Ghost-CLI/issues/368) [#366](https://github.com/TryGhost/Ghost-CLI/issues/366)
...
* **migrate:** improve error handling with sqlite install failure ([9c07274](https://github.com/TryGhost/Ghost-CLI/commit/9c07274)), closes [#281](https://github.com/TryGhost/Ghost-CLI/issues/281)
...
* **mysql:** re-order create user statements ([d690918](https://github.com/TryGhost/Ghost-CLI/commit/d690918)), closes [#511](https://github.com/TryGhost/Ghost-CLI/issues/511)
...
* **prompt:** fix hasDefault check for --auto values ([5385f72](https://github.com/TryGhost/Ghost-CLI/commit/5385f72))
...
* **run:** better handling of ghost run with linux user ([7e0191e](https://github.com/TryGhost/Ghost-CLI/commit/7e0191e)), closes [#317](https://github.com/TryGhost/Ghost-CLI/issues/317)
...
* **setup:** skip ghost user setup if process manager is local ([edce827](https://github.com/TryGhost/Ghost-CLI/commit/edce827)), closes [#607](https://github.com/TryGhost/Ghost-CLI/issues/607)
* **setup:** strip undesirable characters out of DB name ([#486](https://github.com/TryGhost/Ghost-CLI/issues/486)) ([5878002](https://github.com/TryGhost/Ghost-CLI/commit/5878002))
...
* **ui:** 🎨  fixup start & enable flag logic ([d0ff7fe](https://github.com/TryGhost/Ghost-CLI/commit/d0ff7fe)), closes [#313](https://github.com/TryGhost/Ghost-CLI/issues/313)
...
* **ui:** 🎨 template prompt adjustments ([6cee3a3](https://github.com/TryGhost/Ghost-CLI/commit/6cee3a3)), closes [#313](https://github.com/TryGhost/Ghost-CLI/issues/313)
...
* **ui:** fix typo in error output ([#398](https://github.com/TryGhost/Ghost-CLI/issues/398)) ([b44937f](https://github.com/TryGhost/Ghost-CLI/commit/b44937f))
* **ui:** improve sudo output suppression ([398fc27](https://github.com/TryGhost/Ghost-CLI/commit/398fc27))
* **ui:** make fail and success methods output symbols ([#339](https://github.com/TryGhost/Ghost-CLI/issues/339)) ([14a8271](https://github.com/TryGhost/Ghost-CLI/commit/14a8271))
...
* **config:** ip address not configured when specified as option ([#209](https://github.com/TryGhost/Ghost-CLI/issues/209)) ([201dbbf](https://github.com/TryGhost/Ghost-CLI/commit/201dbbf))
* **config:** make configPath correct for ip option ([9b96937](https://github.com/TryGhost/Ghost-CLI/commit/9b96937)), closes [#216](https://github.com/TryGhost/Ghost-CLI/issues/216)
...
* **debug:** normalize debug file path ([e4bfc7c](https://github.com/TryGhost/Ghost-CLI/commit/e4bfc7c)), closes [#228](https://github.com/TryGhost/Ghost-CLI/issues/228)
...
* **extensions:** remove unecessary getters from systemd and nginx extensions ([f5f6e05](https://github.com/TryGhost/Ghost-CLI/commit/f5f6e05)), closes [#254](https://github.com/TryGhost/Ghost-CLI/issues/254)
...
* **help:** 🎨 improve options output ([#246](https://github.com/TryGhost/Ghost-CLI/issues/246)) ([4fb1a5c](https://github.com/TryGhost/Ghost-CLI/commit/4fb1a5c))
...
* **instance:** clean up config usage around application ([#254](https://github.com/TryGhost/Ghost-CLI/issues/254)) ([22c804c](https://github.com/TryGhost/Ghost-CLI/commit/22c804c))
...
* **linux:** fix ghost user setup permissions ([#296](https://github.com/TryGhost/Ghost-CLI/issues/296)) ([ba54099](https://github.com/TryGhost/Ghost-CLI/commit/ba54099)), closes [#290](https://github.com/TryGhost/Ghost-CLI/issues/290)
...
* **ssl:** remove special SSL handling ([#326](https://github.com/TryGhost/Ghost-CLI/issues/326)) ([a4da2a4](https://github.com/TryGhost/Ghost-CLI/commit/a4da2a4))
...
* **ui:** 💄 🐷  various text-only tweaks ([#324](https://github.com/TryGhost/Ghost-CLI/issues/324)) ([f7d6915](https://github.com/TryGhost/Ghost-CLI/commit/f7d6915)), closes [#313](https://github.com/TryGhost/Ghost-CLI/issues/313)
...
* **ui:** log LTS warning when `config.js` file is found ([#273](https://github.com/TryGhost/Ghost-CLI/issues/273)) ([3e54db0](https://github.com/TryGhost/Ghost-CLI/commit/3e54db0)), closes [#236](https://github.com/TryGhost/Ghost-CLI/issues/236) [#216](https://github.com/TryGhost/Ghost-CLI/issues/216)
...
* **uninstall:** actually fix uninstall this time ([5d89600](https://github.com/TryGhost/Ghost-CLI/commit/5d89600)), closes [#220](https://github.com/TryGhost/Ghost-CLI/issues/220)
...
* **uninstall:** ensure uninstall succeeds if using ghost user ([f6a34a8](https://github.com/TryGhost/Ghost-CLI/commit/f6a34a8)), closes [#296](https://github.com/TryGhost/Ghost-CLI/issues/296)
...
* **update:** fix typo in stop error handling ([#306](https://github.com/TryGhost/Ghost-CLI/issues/306)) ([e9e53f9](https://github.com/TryGhost/Ghost-CLI/commit/e9e53f9))
...
* **yarn:** trim newline from end of yarn output ([43ceff1](https://github.com/TryGhost/Ghost-CLI/commit/43ceff1)), closes [#313](https://github.com/TryGhost/Ghost-CLI/issues/313)
...
* **archive:** added support for installing/updating from tarballs ([a079cdc](https://github.com/TryGhost/Ghost-CLI/commit/a079cdc))
...
* **command:** prevent commands run as root user ([#604](https://github.com/TryGhost/Ghost-CLI/issues/604)) ([01481b0](https://github.com/TryGhost/Ghost-CLI/commit/01481b0)), closes [#47](https://github.com/TryGhost/Ghost-CLI/issues/47)
* **db:** remove knex-migrator dep, use one installed with Ghost ([#505](https://github.com/TryGhost/Ghost-CLI/issues/505)) ([9b78843](https://github.com/TryGhost/Ghost-CLI/commit/9b78843)), closes [#503](https://github.com/TryGhost/Ghost-CLI/issues/503)
* **doctor:** allow extensions to provide doctor checks ([4702ce8](https://github.com/TryGhost/Ghost-CLI/commit/4702ce8)), closes [#47](https://github.com/TryGhost/Ghost-CLI/issues/47)
* **doctor:** check current user and dir owner ([9fbd3fd](https://github.com/TryGhost/Ghost-CLI/commit/9fbd3fd)), closes [#47](https://github.com/TryGhost/Ghost-CLI/issues/47)
* **doctor:** check memory before running memory-intensive tasks ([a852cdd](https://github.com/TryGhost/Ghost-CLI/commit/a852cdd))
* **doctor:** content folder permission checks ([#610](https://github.com/TryGhost/Ghost-CLI/issues/610)) ([0075e77](https://github.com/TryGhost/Ghost-CLI/commit/0075e77)), closes [#47](https://github.com/TryGhost/Ghost-CLI/issues/47)
* **doctor:** detect incorrect permissions ([#613](https://github.com/TryGhost/Ghost-CLI/issues/613)) ([6b614f7](https://github.com/TryGhost/Ghost-CLI/commit/6b614f7)), closes [#47](https://github.com/TryGhost/Ghost-CLI/issues/47) [#294](https://github.com/TryGhost/Ghost-CLI/issues/294)
* **doctor:** prevent installations with ghost user ([dde6bf0](https://github.com/TryGhost/Ghost-CLI/commit/dde6bf0)), closes [#47](https://github.com/TryGhost/Ghost-CLI/issues/47)
...
* **help:** add status as an alias for 'ls' ([#380](https://github.com/TryGhost/Ghost-CLI/issues/380)) ([0877523](https://github.com/TryGhost/Ghost-CLI/commit/0877523))
...
* **log:** Log improvements for `ghost update` ([59f5d03](https://github.com/TryGhost/Ghost-CLI/commit/59f5d03)), closes [#562](https://github.com/TryGhost/Ghost-CLI/issues/562)
...
* **process:** allow process.isEnabled to return a promise ([#674](https://github.com/TryGhost/Ghost-CLI/issues/674)) ([c93124b](https://github.com/TryGhost/Ghost-CLI/commit/c93124b)), closes [#672](https://github.com/TryGhost/Ghost-CLI/issues/672)
...
* **process-manager:** allow process isRunning to return a promise ([#669](https://github.com/TryGhost/Ghost-CLI/issues/669)) ([29b4a0b](https://github.com/TryGhost/Ghost-CLI/commit/29b4a0b)), closes [#668](https://github.com/TryGhost/Ghost-CLI/issues/668)
...
* **ssl:** improve error messages to log original error ([#595](https://github.com/TryGhost/Ghost-CLI/issues/595)) ([509aa5a](https://github.com/TryGhost/Ghost-CLI/commit/509aa5a)), closes [#587](https://github.com/TryGhost/Ghost-CLI/issues/587)
...
* add additional node and cli version checks ([8ab4892](https://github.com/TryGhost/Ghost-CLI/commit/8ab4892)), closes [#525](https://github.com/TryGhost/Ghost-CLI/issues/525)
* **casper:** update casper version during ghost update ([008c393](https://github.com/TryGhost/Ghost-CLI/commit/008c393)), closes [#225](https://github.com/TryGhost/Ghost-CLI/issues/225)
...
* **config:** accept mail configuration options ([#244](https://github.com/TryGhost/Ghost-CLI/issues/244)) ([19c905b](https://github.com/TryGhost/Ghost-CLI/commit/19c905b)), closes [#232](https://github.com/TryGhost/Ghost-CLI/issues/232) [#216](https://github.com/TryGhost/Ghost-CLI/issues/216)
...
* **mysql:** mysql user creation extension ([#269](https://github.com/TryGhost/Ghost-CLI/issues/269)) ([78f8439](https://github.com/TryGhost/Ghost-CLI/commit/78f8439)), closes [#191](https://github.com/TryGhost/Ghost-CLI/issues/191)
* **nginx:** add `client_max_body_size` to nginx def. config ([#272](https://github.com/TryGhost/Ghost-CLI/issues/272)) ([b04e7db](https://github.com/TryGhost/Ghost-CLI/commit/b04e7db)), closes [#231](https://github.com/TryGhost/Ghost-CLI/issues/231)
* **nginx:** check dns entry exists before attempting ssl setup ([049f351](https://github.com/TryGhost/Ghost-CLI/commit/049f351)), closes [#190](https://github.com/TryGhost/Ghost-CLI/issues/190)
* **nginx:** move letsencrypt to its own file, add ssl renew command ([b4eb57a](https://github.com/TryGhost/Ghost-CLI/commit/b4eb57a)), closes [#190](https://github.com/TryGhost/Ghost-CLI/issues/190)
* **nginx:** setup ssl renew cron script ([c60cc75](https://github.com/TryGhost/Ghost-CLI/commit/c60cc75)), closes [#216](https://github.com/TryGhost/Ghost-CLI/issues/216)
...
* **ssl:** allow SSL email to be provided via option, skip prompts ([#195](https://github.com/TryGhost/Ghost-CLI/issues/195)) ([8eef01e](https://github.com/TryGhost/Ghost-CLI/commit/8eef01e)), closes [#194](https://github.com/TryGhost/Ghost-CLI/issues/194)
* **ssl:** refactor ssl setup to use acme.sh rather than greenlock ([52cdcab](https://github.com/TryGhost/Ghost-CLI/commit/52cdcab))
* **ssl:** use Mozilla SSL cipher suite ([#252](https://github.com/TryGhost/Ghost-CLI/issues/252)) ([c5091df](https://github.com/TryGhost/Ghost-CLI/commit/c5091df)), closes [#230](https://github.com/TryGhost/Ghost-CLI/issues/230)
...
* **ui:** add command line arg to disable prompts ([e7c6c6a](https://github.com/TryGhost/Ghost-CLI/commit/e7c6c6a)), closes [#233](https://github.com/TryGhost/Ghost-CLI/issues/233)
...
* **ui:** add mail config message after installation ([#278](https://github.com/TryGhost/Ghost-CLI/issues/278)) ([8aac988](https://github.com/TryGhost/Ghost-CLI/commit/8aac988)), closes [#216](https://github.com/TryGhost/Ghost-CLI/issues/216)
* **ui:** add new ui logVerbose method ([09ec161](https://github.com/TryGhost/Ghost-CLI/commit/09ec161))
* **ui:** add troubleshooting link to errors ([#275](https://github.com/TryGhost/Ghost-CLI/issues/275)) ([f5bbff7](https://github.com/TryGhost/Ghost-CLI/commit/f5bbff7)), closes [#216](https://github.com/TryGhost/Ghost-CLI/issues/216)
...
* **version:** add custom version command ([8d96035](https://github.com/TryGhost/Ghost-CLI/commit/8d96035)), closes [#216](https://github.com/TryGhost/Ghost-CLI/issues/216)
...
* lazily require modules in commands ([3f6d8cc](https://github.com/TryGhost/Ghost-CLI/commit/3f6d8cc)), closes [#428](https://github.com/TryGhost/Ghost-CLI/issues/428)
...
<a name="1.23.0"></a>
# [1.23.0](https://github.com/TryGhost/Ghost-CLI/compare/1.22.0...1.23.0) (2022-08-30)



<a name="1.22.0"></a>
# [1.22.0](https://github.com/TryGhost/Ghost-CLI/compare/1.21.1...1.22.0) (2022-08-10)
...
<a name="1.17.2"></a>
## [1.17.2](https://github.com/TryGhost/Ghost-CLI/compare/1.17.1...1.17.2) (2021-05-16)
